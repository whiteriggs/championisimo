      ...
      <section className="hero">
        <div className="hero-inner">
          ...
          <div className="hero-text">
            <div className="hero-eyebrow">Porra Champions 26-27 · Palmarés absurdo</div>
      ...
      {loading || !stats ? (
        ...
        <div className="results-section">
          ...
          <p className="muted prob-note">
            Calculado con los {stats.played} partidos ya jugados. Se actualiza solo conforme avanza la Champions.
