...
function phaseLabel(stage: string, matchday: number | null | undefined): string {
  switch (stage) {
    case "LEAGUE_STAGE":
      return matchday ? `Jornada ${matchday}` : "Fase liga";
    case "PLAYOFFS":
      return "Playoff";
    case "LAST_16":
    case "ROUND_OF_16":
...
const PHASE_FILTERS: { key: string; label: string; stages: string[] }[] = [
  ...
  { key: "league", label: "Fase liga", stages: ["LEAGUE_STAGE"] },
  { key: "po", label: "Playoff", stages: ["PLAYOFFS"] },
  { key: "r16", label: "Octavos", stages: ["LAST_16", "ROUND_OF_16"] },
...
function MatchCard({ m }: { m: ApiAllMatch }) {
  const tag = phaseLabel(m.stage, m.matchday);
      ...
      <section className="hero">
        <div className="hero-inner">
          ...
          <div className="hero-text">
            <div className="hero-eyebrow">Champions 26-27 · Calendario</div>
