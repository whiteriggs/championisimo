        ...
        <>
          {apiError && (
            <div className="results-section">
              <p className="api-notice">Los datos de partidos se cargarán automáticamente cuando empiece la Champions (8 sep 2026).</p>
            </div>
          )}
          ...
          <div className="results-section">
            ...
            {roundData.columns.length === 0 && (
              <p className="muted" style={{ marginTop: 12 }}>
                Aún no hay partidos jugados. El desglose por partido aparecerá aquí en cuanto empiece la Champions.
              </p>
            )}
          </div>
